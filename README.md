...
| Parameter | Type | Description |
| ------------ | ---------------- | --------------------------------------------------------------------------------------- |
| contextName | string | the name of the context in the props passed to the wrapped component |
| fn | js function | the context to pass to the wrapped component |
...
export default compose(
  withContext('context', React.createContext({value: 0}))
)(Component);
```
